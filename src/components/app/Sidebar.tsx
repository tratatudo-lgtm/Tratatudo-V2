...
export function Sidebar({ isOpen, setIsOpen }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { name: 'Vendas', href: '/app/tickets?category=vendas', icon: TrendingUp, area: 'tickets' },
    { name: 'Clientes', href: '/app/clients', icon: Users, area: 'clients' },
    { name: 'Agenda', href: '/app/agenda', icon: Calendar, area: 'calendar' },
    { name: 'Tarefas', href: '/app/tasks', icon: CheckSquare, area: 'tasks' },
    { name: 'Documentos', href: '/app/documents', icon: FileText, area: 'documents' },
    { name: 'Email', href: '/app/email', icon: Mail, area: 'emails' },
