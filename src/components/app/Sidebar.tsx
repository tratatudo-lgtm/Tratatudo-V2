...
export function Sidebar({ isOpen, setIsOpen }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { name: 'Tickets', href: '/app/tickets', icon: Ticket, area: 'pedidos' },
    { name: 'Pedidos', href: '/app/tickets?category=pedidos', icon: ClipboardList, area: 'pedidos' },
    { name: 'Reclamações', href: '/app/tickets?category=reclamacoes', icon: AlertCircle, area: 'reclamacoes' },
    { name: 'Vendas', href: '/app/tickets?category=vendas', icon: TrendingUp, area: 'vendas' },
    ...
    { name: 'Automações', href: '/app/automations', icon: Zap, area: 'automacoes' },
